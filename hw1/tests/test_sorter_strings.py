...
def test_sorter_strings_verify_message():
    SRT = sorter.Sorter()
    assert SRT.sort_nums([3,1,7,0,9,10]) == [0,1,3,7,9,10]
    
def test_sorter_strings_verify_sort_numbers_desc():
